...
SELECT AddGeometryColumn('public', 'parkings', 'the_geom', 32768, 'POINT', 2);
...
SELECT AddGeometryColumn('public', 'parkings_out', 'geom', 32768, 'POINT', 2);
...
SELECT AddGeometryColumn('public', 'refuges', 'the_geom', 32768, 'POINT', 2);
...
SELECT AddGeometryColumn('public', 'refuges_out', 'geom', 32768, 'POINT', 2);
...
SELECT AddGeometryColumn('public', 'sites', 'the_geom', 32768, 'POINT', 2);
...
SELECT AddGeometryColumn('public', 'sites_out', 'geom', 32768, 'POINT', 2);
...
SELECT AddGeometryColumn('public', 'sommets', 'the_geom', 32768, 'POINT', 2);
...
SELECT AddGeometryColumn('public', 'sommets_out', 'geom', 32768, 'POINT', 2);
